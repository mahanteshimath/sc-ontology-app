...
// Vercel builds and serves the app itself and does not want a standalone bundle; Snowflake App
// Runtime requires one. Detect the host rather than picking one and breaking the other target.
